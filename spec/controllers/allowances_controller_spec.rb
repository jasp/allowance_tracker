...
describe AllowancesController do
  ...
  describe "GET index" do
    it "assigns all allowances as @allowances" do
      allowance = FactoryGirl.create :allowance, account: @account
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Allowance" do
        expect {
          post :create, account_id: @account.id, allowance: valid_attributes
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved allowance as @allowance" do
        ...
        post :create, account_id: @account.id, allowance: { started_at: 'invalid value' }
        assigns(:allowance).should be_a_new(Allowance)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the allowances list" do
      allowance = FactoryGirl.create :allowance, account: @account
      delete :destroy, :id => allowance.to_param
      response.should redirect_to(account_allowances_url(@account))
    end
  end
